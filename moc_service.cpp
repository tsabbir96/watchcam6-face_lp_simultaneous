...
QT_MOC_LITERAL(1, 8, 8), // "addTimer"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 12), // "addNotSignal"
QT_MOC_LITERAL(4, 31, 13), // "Notification*"
QT_MOC_LITERAL(5, 45, 8), // "finished"
QT_MOC_LITERAL(6, 54, 13) // "sendNextEmail"

    },
    "service\0addTimer\0\0addNotSignal\0"
...
void service::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->addNotSignal((*reinterpret_cast< Notification*(*)>(_a[1]))); break;
        ...
        {
            typedef void (service::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&service::addTimer)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (service::*_t)(Notification * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&service::addNotSignal)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (service::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&service::finished)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 0
void service::addTimer()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void service::addNotSignal(Notification * _t1)
{
