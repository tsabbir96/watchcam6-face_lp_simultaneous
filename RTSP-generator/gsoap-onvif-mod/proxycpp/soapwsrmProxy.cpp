...
int wsrmProxy::TerminateSequence(const char *endpoint, const char *soap_action, struct wsrm__TerminateSequenceType *wsrm__TerminateSequence, struct wsrm__TerminateSequenceResponseType *wsrm__TerminateSequenceResponse)
{	struct soap *soap = this->soap;
