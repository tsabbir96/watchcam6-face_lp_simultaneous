...
public:
    ...
    void setupUi(QWidget *TileWidget)
    {
        ...
        TileWidget->resize(300, 300);
        gridLayout = new QGridLayout(TileWidget);
        gridLayout->setSpacing(0);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        gridLayout->setContentsMargins(0, 0, 0, 0);
        imageLabel = new QLabel(TileWidget);
        ...
        QFont font;
        font.setFamily(QStringLiteral("Kalpurush"));
    ...
    {
        TileWidget->setWindowTitle(QApplication::translate("TileWidget", "Form", Q_NULLPTR));
        imageLabel->setText(QApplication::translate("TileWidget", "TextLabel", Q_NULLPTR));
    } // retranslateUi
